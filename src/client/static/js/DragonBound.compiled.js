(function(a) {
	function b(b, d) {
		...
		var o, h = this,
			...
			J = !1,
			X, ca, da, ma, Ka, V = u.match(/(ipad|iphone|ipod)/i),
			ea = u.match(/msie/i),
			Oa = u.match(/webkit/i),
			w = u.match(/safari/i) && !u.match(/chrome/i),
			P = u.match(/opera/i),
			ra = u.match(/(mobile|pre\/|xoom)/i) || V,
			za = !y.match(/usehtml5audio/i) && !y.match(/sm2\-ignorebadua/i) && w && !u.match(/silk/i) && u.match(/OS X 10_6_([3-7])/i),
			Ra = "undefined" !== typeof q.hasFocus ? q.hasFocus() : null,
			Pa = w && ("undefined" === typeof q.hasFocus || !q.hasFocus()),
			Ta = !Pa,
			Ua = /(mp3|mp4|mpa|m4a)/i,
			Sa = q.location ? q.location.protocol.match(/http/i) : null,
			Va = !Sa ? "http://" : "",
		...
		this.onready = function(a, b) {
			if ("function" === typeof a) b || (b = r), Ea("onready", a, b), na();
			else
			throw T("needFunction", "onready");
			return !0
		};
		this.ontimeout = function(a, b) {
			if ("function" === typeof a) b || (b = r), Ea("ontimeout", a, b), na({
				type: "ontimeout"
			});
			else
		...
		this.reboot = function() {
			...
			r.setTimeout(h.beginDelayedInit, 20)
		};
		...
		o = function(a) {
			...
			this.stop = function(a) {
				var b = c._iO;
				1 === c.playState && (c._onbufferchange(0), c._resetOnPosition(0), c.paused = !1, c.isHTML5 || (c.playState = 0), u(), b.to && c.clearOnPosition(b.to), c.isHTML5 ? c._a && (a = c.position, c.setPosition(0), c.position = a, c._a.pause(), c.playState = 0, c._onTimer(), j()) : (n._stop(c.id, a), b.serverURL && c.unload()), c.instanceCount = 0, c._iO = {}, b.onstop && b.onstop.apply(c));
				return c
			};
			...
			this.clearOnPosition = function(a, c) {
				...
				if (isNaN(a)) return !1;
				for (b = 0; b < o.length; b++) if (a === o[b].position && (!c || c === o[b].method)) o[b].fired && za--, o.splice(b, 1)
			};
			this._processOnPosition = function() {
				var a, b;
				a = o.length;
				if (!a || !c.playState || za >= a) return !1;
				for (a -= 1; 0 <= a; a--) if (b = o[a], !b.fired && c.position >= b.position) b.fired = !0, za++, b.method.apply(b.scope, [b.position]);
				return !0
			};
			this._resetOnPosition = function(a) {
				...
				c = o.length;
				if (!c) return !1;
				for (c -= 1; 0 <= c; c--) if (b = o[c], b.fired && a <= b.position) b.fired = !1, za--;
				return !0
			};
			r = function() {
				var a = c._iO,
			...
			this._onfinish = function() {
				...
				if (c.instanceCount) {
					c.instanceCount--;
					if (!c.instanceCount && (u(), c.playState = 0, c.paused = !1, c.instanceCount = 0, c.instanceOptions = {}, c._iO = {}, j(), c.isHTML5)) c.position = 0;
		...
		Ga = function() {
			return q.body || q._docElement || q.getElementsByTagName("div")[0]
		};
		p = function(a) {
		...
		oa = function() {
			r.setTimeout(function() {
				h.useFlashBlock && aa();
				na();
				"function" === typeof h.onload && h.onload.apply(r);
				h.waitForWindowLoad && H.add(r, "load", oa)
			}, 1)
		};
		ca = function() {
		...
		Ca = function(a) {
			a._hasTimer || (a._hasTimer = !0, !ra && h.html5PollingInterval && (null === t && 0 === Da && (t = r.setInterval(Ia, h.html5PollingInterval)), Da++))
		};
		ba = function(a) {
		...
		Ia = function() {
			var a;
			if (null !== t && !Da) return r.clearInterval(t), t = null, !1;
		...
		ta = function(a) {
			...
			"function" === typeof h.onerror && h.onerror.apply(r, [{
		...
		Z = function(a, b) {
			...
			if (L && Q) return !1;
			if (h.html5Only) return La(), h.oMC = p(h.movieID), B(), Q = L = !0, !1;
			var d = b || h.url,
				e = h.altURL || d,
				f;
			f = Ga();
			var w, j, k = ga(),
				P, m = null,
				m = (m = q.getElementsByTagName("html")[0]) && m.dir && m.dir.match(/rtl/i),
				a = "undefined" === typeof a ? h.id : a;
			La();
			h.url = S(Sa ? d : e);
			b = h.url;
			h.wmode = !h.wmode && h.useHighPerformance ? "transparent" : h.wmode;
			if (null !== h.wmode && (u.match(/msie 8/i) || !ea && !h.useHighPerformance) && navigator.platform.match(/win32|win64/i)) h.wmode = null;
			f = {
				name: a,
				id: a,
				src: b,
			...
			if (ea) d = q.createElement("div"), j = ['<object id="' + a + '" data="' + b + '" type="' + f.type + '" title="' + f.title + '" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="' + Va + 'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0">', c("movie", b), c("AllowScriptAccess", h.allowScriptAccess), c("quality", f.quality), h.wmode ? c("wmode", h.wmode) : "", c("bgcolor", h.bgColor), c("hasPriority", "true"), h.debugFlash ? c("FlashVars", f.FlashVars) : "", "</object>"].join("");
			else
			for (w in d = q.createElement("embed"), f) f.hasOwnProperty(w) && d.setAttribute(w, f[w]);
			W();
			k = ga();
			if (f = Ga()) if (h.oMC = p(h.movieID) || q.createElement("div"), h.oMC.id) P = h.oMC.className, h.oMC.className = (P ? P + " " : "movieContainer") + (k ? " " + k : ""), h.oMC.appendChild(d), ea && (w = h.oMC.appendChild(q.createElement("div")), w.className = "sm2-object-box", w.innerHTML = j), Q = !0;
			else {
				h.oMC.id = h.movieID;
				...
				try {
					ea || h.oMC.appendChild(d), f.appendChild(h.oMC), ea && (w = h.oMC.appendChild(q.createElement("div")), w.className = "sm2-object-box", w.innerHTML = j), Q = !0
				} catch (ra) {
		...
		Fa = function() {
			...
			H.remove(r, "load", pa);
			if (Pa && !Ra) return !1;
			E || (a = h.getMoviePercent(), 0 < a && 100 > a && (b = !0));
			setTimeout(function() {
				a = h.getMoviePercent();
				if (b) return xa = !1, r.setTimeout(pa, 1), !1;
				!E && Ta && (null === a ? h.useFlashBlock || 0 === h.flashLoadTimeout ? h.useFlashBlock && aa() : Ba(!0) : 0 !== h.flashLoadTimeout && Ba(!0))
			}, h.flashLoadTimeout)
		};
		ua = function() {
			if (Ra || !Pa) return H.remove(r, "focus", ua), !0;
			Ra = Ta = !0;
			xa = !1;
			pa();
			H.remove(r, "focus", ua);
		...
		I = function(a) {
			...
			var b = !0,
				c;
			if (!h.useFlashBlock || !h.flashLoadTimeout || h.getMoviePercent()) E = !0, M && (c = {
			...
			M || (h.waitForWindowLoad && !N ? H.add(r, "load", oa) : oa());
			return b
		};
		A = function() {
		...
		B = function() {
			if (E) return !1;
			if (h.html5Only) return E || (H.remove(r, "load", h.beginDelayedInit), h.enabled = !0, I()), !0;
			va();
			try {
				n._externalInterfaceTest(!1), D(!0, h.flashPollingInterval || (h.useHighPerformance ? 10 : 50)), h.debugMode || n._disableDebug(), h.enabled = !0, h.html5Only || H.add(r, "unload", x)
			} catch (a) {
				return ta({
			...
			I();
			H.remove(r, "load", h.beginDelayedInit);
			return !0
		};
		sa = function() {
			if (wa) return !1;
			...
			q.removeEventListener && q.removeEventListener("DOMContentLoaded", sa, !1);
			va();
			return !0
		};
		Na = function() {
			"complete" === q.readyState && (sa(), q.detachEvent("onreadystatechange", Na));
			return !0
		};
		R = function() {
			N = !0;
		...
		H.add(r, "load", pa);
		H.add(r, "load", R);
		q.addEventListener ? q.addEventListener("DOMContentLoaded", sa, !1) : q.attachEvent ? q.attachEvent("onreadystatechange", Na) : ta({
			type: "NO_DOM2_EVENTS",
			fatal: !0
		});
		"complete" === q.readyState && setTimeout(sa, 100)
	}
	var d = null;
		...
		a.cssHooks["backgroundPosition" + d] = {
			...
			set: function(c, e) {
				var k = b(a.css(c, "backgroundPosition")),
					o = d === "X";
				c.style.backgroundPosition = (o ? e : k.X) + " " + (o ? k.Y : e)
			}
		};
...
(function(a) {
	...
	function d(c, d) {
		var e, k, o = "matrixFilter" === a.cssProps.transformOrigin ? !0 : !1;
		...
		o && (o = c.offsetWidth, e = c.offsetHeight, c.style.position = "relative", c.style.left = h * (p - o) + (parseInt(d[4]) || 0), c.style.top = n * (u - e) + (parseInt(d[5]) || 0))
	}
						...
						set: function(b, e, k) {
							...
							if (a.support.matrixFilter) d(b, e);
								...
								var B = /[X|Y]/.exec(m),
									...
									K = false,
									L;
								if (r !== null) for (var Q in r) {
									L = r[Q];
									if (m === Q) {
										if (m !== "matrix") {
											s = s + (m + "(");
											s = s + (B === "X" || B === "" ? e + k : L[0] !== "" ? L[0] : a.cssHooks[m + "X"].get(b) + k);
											s = s + (B === "Y" ? ", " + e + k : L[1] !== "" ? ", " + L[1] : m + "Y" in a.cssHooks ? ", " + a.cssHooks[m + "Y"].get(b) + k : "");
											s = s + ") "
										} else s = s + (e + " ");
										K = true
									} else {
								...
								K || (s = s + (m + B + "(" + e + k + ") "));
								b.style[a.cssProps.transform] = s
							}
						},
						get: function(b) {
...
(function(a) {
	function b(b, c) {
		var e, f;
		function j(b) {
			B.start = y ? b.pageX : b.pageY;
			b = parseInt(r.obj.css(q));
			e = "auto" == b ? 0 : b;
			...
			r.obj.bind("mouseup", k);
			r.obj[0].ontouchend = document.ontouchend = function(b) {
				a(document).unbind("mouseup");
				r.obj.unbind("mouseup");
				k(b.touches[0])
			};
			return !1
		}
		function m(a) {
			1 <= n.ratio || (A -= (a.wheelDelta ? a.wheelDelta / 120 : -a.detail / 3) * c.wheel, A = Math.min(n[c.axis] - h[c.axis], Math.max(0, A)), r.obj.css(q, A / p.ratio), n.obj.css(q, -A), a.preventDefault())
		}
		function k() {
			a(document).unbind("mousemove", o);
			a(document).unbind("mouseup", k);
			r.obj.unbind("mouseup", k);
			document.ontouchmove = r.obj[0].ontouchend = document.ontouchend = null;
			return !1
		}
		function o(a) {
			1 <= n.ratio || (f = Math.min(u[c.axis] - r[c.axis], Math.max(0, e + ((y ? a.pageX : a.pageY) - B.start))), A = f * p.ratio, n.obj.css(q, -A), r.obj.css(q, f));
			return !1
		}
		var h = {
			obj: a(".viewport", b)
		...
		this.update = function(a) {
			...
			u[c.axis] = "auto" == c.size ? h[c.axis] : c.size;
			r[c.axis] = Math.min(u[c.axis], Math.max(0, "auto" == c.sizethumb ? u[c.axis] * n.ratio : c.sizethumb));
			p.ratio = "auto" == c.sizethumb ? n[c.axis] / u[c.axis] : (n[c.axis] - h[c.axis]) / (u[c.axis] - r[c.axis]);
			...
			r.obj.css(q, A / p.ratio);
			n.obj.css(q, -A);
			B.start = r.obj.offset()[q];
			a = x.toLowerCase();
			p.obj.css(a, u[c.axis]);
			u.obj.css(a, u[c.axis]);
			r.obj.css(a, r[c.axis]);
			Number(n.obj.css("height").slice(0, -2)) > Number(h.obj.css("height").slice(0, -2)) ? p.obj.show() : p.obj.hide()
		};
		this.update();
		(function() {
			r.obj.bind("mousedown", j);
			r.obj[0].ontouchstart = function(a) {
				a.preventDefault();
				r.obj.unbind("mousedown");
				j(a.touches[0]);
				return !1
			};
			u.obj.bind("mouseup", o);
		...
		n = c.BufferedBlockAlgorithm = f.extend({
			...
			_process: function(b) {
				var c = this._data,
					...
					e = a.min(4 * b, e);
				if (b) {
					for (var k = 0; k < b; k += f) this._doProcessBlock(d, k);
					k = d.splice(0, b);
					c.sigBytes -= e
				}
...
(function(a) {
	for (var b = CryptoJS, d = b.lib, c = d.WordArray, e = d.Hasher, d = b.algo, f = [], j = [], m = function(a) {
		...
		h && (8 > o && (f[o] = m(a.pow(k, 0.5))), j[o] = m(a.pow(k, 1 / 3)), o++);k++
	}
	var u = [],
		d = d.SHA256 = e.extend({
			_doReset: function() {
			...
			_doProcessBlock: function(a, b) {
				for (var c = this._hash.words, d = c[0], e = c[1], f = c[2], h = c[3], k = c[4], m = c[5], o = c[6], n = c[7], p = 0; 64 > p; p++) {
					if (16 > p) u[p] = a[b + p] | 0;
					else {
						var N = u[p - 15],
							I = u[p - 2];
						u[p] = ((N << 25 | N >>> 7) ^ (N << 14 | N >>> 18) ^ N >>> 3) + u[p - 7] + ((I << 15 | I >>> 17) ^ (I << 13 | I >>> 19) ^ I >>> 10) + u[p - 16]
					}
					N = n + ((k << 26 | k >>> 6) ^ (k << 21 | k >>> 11) ^ (k << 7 | k >>> 25)) + (k & m ^ ~k & o) + j[p] + u[p];
...
function LoadTwitter() {
	...
	a.getElementById("twitter-wjs") || (a = a.createElement("script"), a.id = "twitter-wjs", a.src = "//platform.twitter.com/widgets.js", b.parentNode.insertBefore(a, b))
}
...
function ChatReceived(a, b, d, c, e, f) {
	...
	debug && console.log("type:", d);
	d == CHAT_TYPE_GM_BUGLE && (debug && console.log("SYSTEM:", a), a = a.replace('<a href="http://www.facebook.com/dragonbound.net" target="_blank">DragonBound Community/News</a>', '<a href="http://www.dragonbound-news.com/" target="_blank">DragonBound News (NEW!)</a>'));
	var j = "",
		m = "",
		k = "",
		o = "";
	if (e == LOCATION_TYPE_CHANNEL || $("#channelScreen").is(":visible") || $("#shopScreen").is(":visible")) m = "#channelTextHtml", j = "#channel";
	else if ($("#roomScreen").is(":visible")) m = "#roomChatHtml", j = "#roomChat", k = ".roomPlayerBalloon", o = ".roomPlayerBalloonTip", "" != k && "" != b && $(".roomPlayerName").each(function() {
		if ($(this).html().split("</span> ").pop() == b) {
			var c = $(this).parents().children(k),
				e = $(this).parents().children(o);
			d == 4 ? c.addClass("bg1") : c.removeClass("bg1");
			d == 5 ? c.addClass("bg2") : c.removeClass("bg2");
			e.stop(true, true).fadeOut("slow");
...
DragonLanguage.prototype.SetAll = function() {
	...
	$("#dialog_join_room_div .AlertBoxTitle").html(this.t("Join Room"));
...
function classic() {
	...
	DragonTheme_SetTheme(DragonThemeInUse);
	alertify.alert("Maps/Ranks/Mobiles HACK Activated! ;)<br><br>(You can disable or edit it at the options window)<br><br>")
};
...
function CDamageEffect(a, b, d, c, e, f) {
	...
	k = String(d);
	"Red" != j && 0 < d && (k = "+" + k);
	for (var o = '<div class="DamageEffect" damage=' + d + " x=" + a + " y=" + b + ' id="' + m.slice(1) + '" style="left: ' + a + "px; top: " + b + 'px;">', h = 0; h < k.length; h++) {
...
function DragonBound(a, b, d) {
	...
	this.t = random(10, 20);
	this.s = random(60, 70);
	this.is_s1_disabled = r;
	this.dn = d;
	this.camera = new CCamera(p, function(a, b) {
		y.OnCameraUpdate(a, b)
	});
	...
	this.UpdateTurnList();
	r ? ($("#btnShot1").hide(), SelectShotType(1, void 0), this.ChangedShot(1)) : ($("#btnShot1").show(), SelectShotType(0, void 0), this.ChangedShot(0));
	$("#btnShotSS").show();
	this.StartNextTurn();
	this.QueueUnblock();
	$(".EventGameMsg1").remove();
	1 == u && $("#game_front").append($('<div class="EventGameMsg1 blackShadow">- ' + l.t("Event Game") + " -<br>" + l.t("Losing Team Wins!<br>Double GP & Gold!") + "</div>"))
}
		...
		f = function(b) {
			...
			if (a.tele) for (f = 0; f < a.tele.length; f += 5) {
				var b = a.tele[f + 1],
					...
					h = a.tele[f + 3],
					n = a.tele[f + 4],
					p = e.GetPlayerByPlayerNumber(a.tele[f]);
				p && (p.MoveTo(b, j, void 0, !0), p.MoveTo(h, n, void 0, !1), p.OnCameraUpdate(e.last_event_left, e.last_event_top), CreateExplode(a.exp, b, j))
			}
...
DragonBound.prototype.GameOver = function(a) {
	...
	for (var b = 0; b < a.scores.length; b++) {
		...
		$("#score" + c + " .score_bonus_gp").html(o ? "+" + o + " GP" : "");
	...
	$(".Player").promise().done(function() {
		...
		g_score_screen_timeout = setTimeout(function() {
			a.location == GUI_LOCATION_GAME && (a.should_stay_in_game_screen = !1, a.myPlayerInfo.location_type == LOCATION_TYPE_CHANNEL ? SwitchToChannelScreen(a) : SwitchToRoomScreen(a))
		}, 7500);
		$("#game_over").click(function() {
			g_score_screen_timeout && (g_score_screen_timeout = clearTimeout(g_score_screen_timeout), a.should_stay_in_game_screen = !1, a.myPlayerInfo.location_type == LOCATION_TYPE_CHANNEL ? SwitchToChannelScreen(a) : SwitchToRoomScreen(a))
		})
	})
};
...
DragonBound.prototype.DrawWind = function(a, b) {
	...
	d.clearRect(0, 0, 54, 54);
	c && d.drawImage(c, 177, 159, 54, 54, 0, 0, 54, 54);
	d.save();
	d.translate(27, 27);
...
function CAnimatedObject(a, b, d, c, e, f, j, m, k, o, h, n, p, u, r, y, q) {
	this.frames = h;
	this.start_frame = void 0 == r ? 0 : r;
	this.end_frame = y;
	this.frame_time = n;
	this.loop_type = u;
	this.css_prefix = a;
	...
	d = Math.round(d);
	c = Math.round(c);
	$(k).append('<div class="AniObject ' + a + "-" + this.start_frame + (this.is_flip ? " FlipH" : "") + '" id="' + this.div_id.slice(1) + '" style="position: absolute; left:' + d + "px; top:" + c + "px; width: " + e + "px; height: " + f + "px; margin-left: " + -j + "px; margin-top: " + -m + "px; opacity: " + o + "; background-image: url(" + STATIC_DIR2 + "images/" + b + "); background-repeat: no-repeat;background-color: transparent; zoom:1;" + (q ? " z-index:" + q : "") + '"></div>');
	if (3 != this.loop_type) {
		var x = this;
		this.interval = setInterval(function() {
			x.update()
...
function CAnimatedObject2(a, b, d, c, e, f, j, m, k, o, h, n) {
	this.graphics = b;
	...
	m = b[o][GRAPHICS_INDEX_HEIGHT];
	k = b[o][GRAPHICS_INDEX_CENTER_X];
	b = b[o][GRAPHICS_INDEX_CENTER_Y];
	o = this.frames_x[o];
	k = this.is_flip ? k - j : -k; - 1 == a.indexOf(":") && (a = STATIC_DIR2 + "images/" + a);
	this.div = $("<div/>", {
		"class": "AniObject" + (this.is_flip ? " FlipH" : ""),
		style: "position: absolute; left:" + d + "px; top:" + c + "px; width: " + j + "px; height: " + m + "px; margin-left: " + k + "px; margin-top: " + -b + "px; opacity: " + f + "; background-image: url(" + a + "); background-repeat: no-repeat;background-color: transparent; zoom:1; background-position: -" + o + "px 0; z-index:" + h + ";"
	}).appendTo(e);
...
function CreateExplode(a, b, d) {
	if (a = EXPLODES[a]) new CAnimatedObject2("explodes/" + a.file + ".png", a.graphics, b, d, "#game_objects", 0.75, 20, !1, LOOP_ONCE, 0, 20, !0), AudioPlay(a.sound)
};
...
DragonNetwork.prototype.ConnectToGameServer = function(a, b) {
	...
	var e = [];
	e[SERVER_OPCODE.hi] = function(a, b, e) {
		debug && console.log("Receive: hi", a, b, e);
		a != VERSION && a != VERSION2 ? (g_dont_show_disconnect_window = !0, d.Disconnect(), DragonDialogOpen(l.t("Update Available"), l.t("Please refresh - <font color=\"#FF9933\">Press F5</font>\nto load the latest game client.\n\nIf it doesn't help try Shift+F5 or clear your browser's cache."))) : (g_server_version = a, DragonDialogOpen(l.t("Login") + "... " + l.t("Please Wait"), l.t("Connected") + ". (" + l.t(b) + ")<br><br>" + l.t("Login") + "...", DIALOG_BUTTONS_OK, void 0, [35, 52]), debug && console.log("Send: login", a, c.user_id), d.Send(CLIENT_OPCODE.login, a, c.user_id, c.user_auth_key), e != g_server_type && (g_server_type = e, SetLobby(c, e)), TournamentWaitingMsgHide())
	};
	...
	e[SERVER_OPCODE.dead] = function(a) {
		...
		c.game ? c.game.QueueAddCommand("dead", a) : DragonDialogOpen("Oops (3)", l.t("Missed game start<br><br>Refresh (F5) or close the window for 30 seconds then come back to fix this."), DIALOG_BUTTONS_OK)
	};
	...
	e[SERVER_OPCODE.changed_team] = function(a, b, d, e, o) {
		debug && console.log("Receive: changed_team", a, b, d, e, o);
...
function Alert2(a, b) {
	...
	case ALERT2_TYPES.GUILDS_LOCK:
		d = l.t("Sorry"), c = l.t("Guilds are locked during the tournament. Try again later.")
	}
...
DragonNetwork.prototype.BrokerResponse2 = function(a) {
	...
	if (b != VERSION && b != VERSION2) DragonDialogOpen(l.t("Update Available"), l.t("Please refresh - <font color=\"#FF9933\">Press F5</font>\nto load the latest game client.\n\nIf it doesn't help try Shift+F5 or clear your browser's cache."));
		...
		for (var f = 3; f < a.length; f++) {
			var j = f - 3,
				m = $("#BrokerChannel" + j);
			m.attr("channel_number", j);
			d++;
			if (Array.isArray(a[f])) {
				...
				m.attr("ip", a[f][1]);
				m.attr("port", a[f][2]);
				0 < h && (24 == e || o < h && (void 0 == n || n <= e) && (void 0 == p || e <= p)) ? m.addClass("BrokerChannelOnline opacity_button") : (o >= h && 0 < h && m.addClass("BrokerChannelFull"), c++);
				b++;
				var u = "";
				void 0 != n && void 0 != p && (u = '<div class="BrokerRanks"><span class="InlineRank rank rank' + n + '"></span> - <span class="InlineRank rank rank' + p + '"></span></div>');
				o = 74 * o / h;
				74 < o && (o = 74);
				m.html('<div class="BrokerChannelName blackShadow">' + l.t("Server") + " " + (j + 1) + " - " + l.t(k) + '</div> <div class="BrokerMaxPlayers2"></div> <div class="BrokerNumPlayers2" style="width:' + o + 'px"></div><div class="BrokerChannelFullIcon"></div>' + u)
			} else m.html('<div class="BrokerChannelName blackShadow">' + l.t("Server") + " " + (j + 1) + " - Offline</div>")
		}
		c >= b && $("#BrokerTitle").html(l.t("All worlds are currently full. Press this button to refresh") + " ->");
		1 == d ? ($(".BrokerChannel").hide(), $("#BrokerChannel0").css("left", 223).show(), $("#BrokerWindow").css({
			height: 192,
			top: 204
		})) : 2 == d ? ($(".BrokerChannel").hide(), $("#BrokerChannel0").css("left", 119).show(), $("#BrokerChannel1").css("left", 326).show(), $("#BrokerWindow").css({
			height: 192,
			top: 204
		})) : 3 == d ? ($(".BrokerChannel").hide(), $("#BrokerChannel0,#BrokerChannel1,#BrokerChannel2").css("left", "").show(), $("#BrokerWindow").css({
			height: 192,
			top: 204
...
function BooleanArrayToImageData(a, b, d) {
	...
	for (e = 0; e < m; e++) for (c = 0; c < j; c++) k[4 * (e * j + c) + 3] = a[f] == o ? 255 : 0, f++;
...
CGround.prototype.AddGroundHole = function(a, b, d, c) {
	...
	for (e = a - d - 10; e <= a; e++) {
		p = !1;
		for (d = b - c - 10; d < b; d++) if (f = e - a, j = d - b, m = f * f / k + j * j / o, !p && 1.2 > m) {
			if (p = !0, h = e, n = d, j = b - j, this.AddGroundShadowColumn(h, n, j), 0 != f && (h = a - f, this.AddGroundShadowColumn(h, n, j)), 1.2 <= m && p) break
		} else if (1 > m) {
			h = e;
			n = d;
			j = b - j;
...
CPlayer.prototype.CreateDivs = function() {
	...
	if (this.is_me) {
		...
		this.myAngleContext = $("#MyAngle")[0].getContext("2d");
		this.divMobile.append(this.aimCircleCanvas);
		var a = this,
			b = this.aimCircleImage = new Image;
		b.onload = function() {
			a.UpdateGuiAngle();
			a.DrawPlayerAngle()
		};
		b.src = GetBackgroundImageUrl("#gameui")
	}
	...
	b = MOBILES[this.mobile];
	b.ion_file && (this.ion = new CAnimatedObject2("mobiles/" + b.ion_file + ".png", b.ion_graphics, 0, 0, this.divIon, 1, ANIMATIONS_FPS, this.flip, LOOP_NORMAL, 0, 2, !0), this.SetIon(90, 0, -200));
	this.divTurn = $("<div/>", {
		"class": "Turn"
	});
	this.divBalloon = $("<div/>", {
...
CPlayer.prototype.UpdateGuiAngle = function() {
	if (this.is_me) {
		...
		b.clearRect(0, 0, 86, 86);
		d && (0 > a && (b.drawImage(d, 801, 154, 13, 13, 0, 0, 13, 13), a *= -1), b.drawImage(d, 801, 14 * Math.floor(a / 10) + 14, 13, 13, 13, 0, 13, 13), b.drawImage(d, 801, 14 * (a % 10) + 14, 13, 13, 26, 0, 13, 13), b.drawImage(g_dirty, -1, -1, 1, 1))
	}
};
...
function RoomGUI(a) {
	...
	$("#roomButtonMobile").click(function() {
		AudioPlay(AUDIO_BUTTON_SELECT2);
		var b = a.myPlayerInfo.mobile + 1;
		b > LAST_SELECTABLE_MOBILE && (b = FIRST_SELECTABLE_MOBILE);
		a.SendRoomChangeMobile(b)
	});
...
function InfoDialogReceiveInfo(a) {
	...
	$("#infoGender").html(b == GENDER_MALE ? l.t("Male") : l.t("Female"));
	$("#infoRank").removeClass().addClass("rank rank" + a[INFO_INDEX_RANK]);
	$("#infoWin").html(a[INFO_INDEX_WIN]);
	$("#infoLose").html(a[INFO_INDEX_LOSE]);
	$("#infoGuild").html(a[INFO_INDEX_GUILD]);
	var d = "";
	a[INFO_INDEX_GUILD] && (0 == a[INFO_INDEX_GUILD_JOB] ? d = l.t("Member") : 1 == a[INFO_INDEX_GUILD_JOB] ? d = l.t("Leader") : 2 == a[INFO_INDEX_GUILD_JOB] && (d = l.t("Semi-Leader")));
	$("#infoGuildJob").html(d);
	a = a[INFO_INDEX_FACEBOOK_ID];
	a = "" == a ? b == GENDER_FEMALE ? STATIC_DIR + "images/fb_girl.gif" : STATIC_DIR + "images/fb_boy.gif" : "http://graph.facebook.com/" + a + "/picture?type=large";
...
function OpenBotSelectDialog(a, b) {
	...
	for (var c = $("#select_bot_div"), e = "", f, j, m, k, o, h, n, p = 0; p < COMPUTER_PLAYER.length; p++) n = COMPUTER_PLAYER[p], p <= d ? (f = n.rank, j = n.name, m = n.gp, k = n.atk, o = n.def, h = n.life, n = n.dig) : (f = 25, j = "???", m = n.gp, k = o = h = n = "??"), e += '<div class="bs_line" id=' + p + '> <div class="bs_rank rank rank' + f + '"></div> <div class="bs_name">' + j + '</div> <div class="bs_gp">GP:' + m + "</div>", e += '<div class="bs_atk_icon  stat_icon stat_icon_atk"></div> <div class="bs_atk">' + k + '</div><div class="bs_def_icon  stat_icon stat_icon_def"></div> <div class="bs_def">' + o + '</div><div class="bs_life_icon stat_icon stat_icon_life"></div><div class="bs_life">' + h + '</div><div class="bs_dig_icon  stat_icon stat_icon_dig"></div> <div class="bs_dig">' + n + "</div></div>";
	c.html(e);
...
function RoomPlayerUpdateGUI(a) {
	...
	for (var j = 0; j < f; j++) {
		...
		if (b) {
			...
			if (b.user_id == a.user_id) {
				...
				b.is_master ? ($("#roomButtonStart").show(), $("#roomButtonReady").hide()) : ($("#roomButtonReady").show(), $("#roomButtonStart").hide());
			...
			k.show()
		} else k.children(".roomPlayerBalloon, .roomPlayerBalloonTip").removeClass("text_anim"), k.children(".roomPlayerName").html(""), k.hide(), o && (o.remove(), g_room_slot_graphic2[j] = void 0)
	}
	$("#add_bot_button").hide();
	...
	$("#room_game_mode").hasClass("gameModeBoss") && (g_can_change_team = !1);
	...
	for (j = 0; j < f; j++) b = g_room_players_slots[j], m = "#playerInRoom" + j, k = $(m), m = 0 == j % 2 ? c : e, o = (!d || "." == d ? 257 - 48 * (Math.floor(m) - 1) : 113) + 97 * Math.floor(j / 2), k.css("top", o), k = $("#vortex" + j), k.css("top", o - 50), b ? k.hide() : (Math.floor(j / 2) < m ? k.show() : k.hide(), g_game_mode == GAME_MODE_BOSS && (j == 2 * e - 1 && 0 < a.unlock) && ($("#add_bot_button").css("top", o + 40).show(), g_add_bot_to_slot = j))
}
	...
	b.onload = function() {
		...
		if (400 > a || 400 > c || 2E3 < a || 2E3 < c) alertify.alert("Image size need to be: 400x400-2000x2000 (We got " + a + "x" + c + ")");
			...
			if (5E4 < m.length) alertify.alert("File size is too big. Please decrease the file size.");
				...
				for (var k = 0, o = 0, j = 0; j < e.length; j++) e[j] ? o++ : k++;
...
function BooleanArrayToCanvas(a, b, d, c, e) {
	...
	f.width = c;
	f.height = e;
	for (var j = f.getContext("2d"), m = j.getImageData(0, 0, c, e), k = m.data, o = "string" == typeof a ? "1" : !0, h = 0; h < e; h++) for (var n = 0; n < c; n++) {
		var p = 4 * (h * c + n);
		k[p] = k[p + 1] = k[p + 2] = 0;
		k[p + 3] = a[Math.floor(h * d / e) * b + Math.floor(n * b / c)] == o ? 255 : 0
	}
...
function DragonRankings_BuildPage(a, b, d, c) {
	for (var e = a.length, f = a[1], j = f, m = "<table>", k = 2, o, h, n, p, u = d.myPlayerInfo ? d.myPlayerInfo.game_id : ""; k < e;) {
		o = a[k++];
		h = a[k++];
		n = a[k++];
		p = "string" == typeof a[k] ? a[k++] : "";
		m += "<tr";
		if (n == u || n == c) m += ' class="ranking_me"';
		m += "><td>" + j + '</td><td><div class="rank rank' + h + '"></div></td><td><div class="ranking_name"><span class="GuildName">' + p + "</span> " + n + "</div></td><td>" + o + "</td></tr>";
		j++
	}
	m += "</table>";
	...
	$("#btnMe").click(function() {
		var a = d.myPlayerInfo ? d.myPlayerInfo.game_id : "";
		a ? LoadRanking(b, a, d) : alertify.log("Don't know who you are, enter a server.")
	});
...
function ShopSetMyItems2(a, b) {
	...
	for (var j = 0; j < a.length; j++) {
		var m = a[j],
			...
			u = m[5],
			r = AVATARS[o];
		if (void 0 == r) debug && console.log("*** ERROR: Unknown avatar:", m);
		else {
			var m = r[AVATAR_INDEX_TYPE],
				y = r[AVATAR_INDEX_GENDER],
				q = r[AVATAR_INDEX_NAME],
				x = void 0;
			...
			continue;
			d += '<div id="shop_my_item' + j + '" class="shop_my_item" onmousedown="ShopSelectMyItem(' + j + ",'" + b + '\')" avatar_id="' + k + '" avatar_number="' + o + '" avatar_type="' + m + '">';
			u ? d += '<div class="shop_my_item_gift"></div>' : p && (d += '<div class="shop_my_item_cash"></div>');
			d += '<div class="shop_my_item_icon shop_item_icon_' + m + y + '"></div><div class="shop_my_item_name">' + q + (x ? " (" + x + ")" : "") + '</div><div class="shop_my_item_equip' + (h ? " equipped" : "") + ' "></div>';
			for (p = k = 0; p < c.length; p++) u = e[p], n = c[p], r[u] && (d += '<div class="shop_my_item_stat shop_my_item_stat' + k + '"> <div class="stat_icon stat_icon_' + (0 < r[u] ? n : n + "-") + '"></div> <div class="stat_digit1 stat_font stat_font' + Math.floor(Math.abs(r[u] / 10)) + '"></div> <div class="stat_digit2 stat_font stat_font' + Math.abs(r[u] % 10) + '"></div> </div>', k++);
			d += "</div>";
			h && g_shop_player.change(o);
			9E3 == r[AVATAR_INDEX_N] && (f = !0)
		}
	}
...
function ShopSetPage(a, b, d, c) {
	...
	for (f = 0; f < e.length; f++) {
		...
		m = d[AVATAR_INDEX_URL] ? d[AVATAR_INDEX_URL] : j == AVATAR_TYPE_BACKGROUND ? STATIC_DIR + "images/backgrounds/b20" + m + ".png" : j == AVATAR_TYPE_FOREGROUND ? STATIC_DIR + "images/backgrounds/f20" + m + ".png" : STATIC_DIR + "images/avatars/" + k + j + (m + 1E5).toString().substring(1) + ".png";
...
function ChannelGUI(a) {
	...
	$(".BrokerChannel").click(function() {
		if ($(this).hasClass("BrokerChannelOnline")) {
			a.ConnectToGameServer($(this).attr("ip"), $(this).attr("port"));
			var b = $(this).attr("channel_number"),
				d = $("#BrokerChannel" + b + " .BrokerChannelName").html();
			$("#channelName").html(d);
			a.server = b
		}
	});
...
function BuildPlayerNameWithGuild(a, b, d) {
	a && (b = d ? '<span class="GuildNameTeam' + d + '">' + a + "</span> " + b : '<span class="GuildName">' + a + "</span> " + b);
	return b
}
...
function SetLobby(a, b) {
	...
	1 == b ? ($("#buttonQuickJoin,#buttonCreateRoom,#buttonJoin,#buttonRoomsListUp,#buttonRoomsListDown,#filter_all,#filter_waiting,#filter_normal,#filter_boss,#filter_same,#filter_friends,#filter_guild,.room").hide(), $("#buttonStart1v1,#lobbyButtonMobile,#tournament_info").show(), $("#channelScreen").css({
		"background-image": "none"
	}), $("body").css({
		"background-image": "url(/static/images/themes/full_bg2.jpg)"
	}), void 0 == a.lobbyMobile && (a.lobbyMobile =
	MOBILE.RANDOM)) : ($("#buttonQuickJoin,#buttonCreateRoom,#buttonJoin,#buttonRoomsListUp,#buttonRoomsListDown,#filter_all,#filter_waiting,#filter_normal,#filter_boss,#filter_same,#filter_friends,#filter_guild,.room").show(), $("#buttonStart1v1,#lobbyButtonMobile,#tournament_info").hide(), $("#channelScreen").css({
		"background-image": ""
	}), $("body").css({
		"background-image": ""
...
function SetTournamentInfo2(a) {
	var b;
	b = "" + ("Players: " + a[2] / 2 + "v" + a[2] / 2 + "<br>");
	b += "Avatar: " + (a[3] ? "On" : "Off") + "<br>";
	b += "Wind: " + a[4] + "<br>"; - 1 != a[5] && (b += "Mobile: " + MOBILE_NAME[a[5]] + "<br>");
	b += "<br>" + l.t("Games Now") + ": " + a[9] + "<br>";
	b += l.t("Games Last 5 Minutes") + ": " + a[8] + "<br>";
	b += l.t("Games Since Server Reset") + ": " + a[7] + "<br>";
	0 < a[8] && (b += l.t("Average Waiting Time") + ": " + (150 / a[8]).toFixed(1) + " " + l.t("Seconds") + "<br>");
	var d = a[0],
		a = a[1];
	0 < d ? (b += "<br>Start Time: " + SecondsToString(d) + "<br>", a && a > d && (b += "Tournament Time: " + SecondsToString(a - d) + "<br>")) : a && (b += "<br>End Time: " + SecondsToString(a) + "<br>");
	$("#tournament_info").html(b)
};
...
function ResellersGUI(a) {
	$("#buttonCharge2").click(function() {
		AudioPlay(AUDIO_BUTTON_SELECT2);
		$("#chargeWindow").show();
		"br" == SERVER_TYPE && ($("#resellers_btn").hide(), $("#charge_pin_btn").hide());
		$("#charge_myinfo_btn").click()
	});
		...
		return x = {
			...
			addListeners: function(a) {
				var d, e, h, k, o, n = j !== b,
					...
					x = this;
				d = function(c) {
					return c.preventDefault !== b && c.preventDefault(), h(c), r !== b && (y = r.value), "function" == typeof a && (r !== b ? a(!0, y) : a(!0)), !1
				};
				e = function(c) {
				...
				h = function() {
					...
					x.unbind(m, "focus", o);
					q && x.unbind(u, "submit", d);
					n && x.unbind(j, "click", d);
					p && x.unbind(f, "click", e)
				};
				k = function(a) {
					var b = a.keyCode;
					32 !== b || q || d(a);
			...
			build: function(a) {
				var b = "",
					...
					d = a.message,
					a = a.cssClass || "";
				switch (b += '<div class="alertify-dialog">', "none" === q.buttonFocus && (b += '<a href="#" id="alertify-noneFocus" class="alertify-hidden"></a>'), "prompt" === c && (b += '<form id="alertify-form">'), b += '<article class="alertify-inner">', b += x.message.replace("{{message}}", d), "prompt" === c && (b += x.input), b += x.buttons.holder, b += "</article>", "prompt" === c && (b += "</form>"), b += '<a id="alertify-resetFocus" class="alertify-resetFocus" href="#">Reset Focus</a>', b += "</div>", c) {
				case "confirm":
			...
			dialog: function(a, d, e, f, j) {
				o = c.activeElement;
				var k = function() {
					p && null !== p.scrollTop && h && null !== h.scrollTop || k()
				};
				...
				return "function" == typeof this.init && (this.init(), k()), B.push({
					type: d,
					message: a,
					callback: e,
					placeholder: f,
			...
			setup: function(a) {
				...
				k = "cancel" === q.buttonFocus ? f : "none" === q.buttonFocus ? d("alertify-noneFocus") : j;
				r = d("alertify-text") || b;
				u = d("alertify-form") || b;
				"string" == typeof h.placeholder && "" !== h.placeholder && (r.value = h.placeholder);
				a && this.setFocus();
...
(function() {
		...
		function e(a, b) {
			...
			case "object":
				...
				if ("[object Array]" === Object.prototype.toString.apply(p)) {
					k = p.length;
					for (f = 0; f < k; f += 1) o[f] = e(f, p) || "null";
					return w = 0 === o.length ? "[]" : j ? "[\n" + j + o.join(",\n" + j) + "\n" + P + "]" : "[" + o.join(",") + "]", j = P, w
				}
				if (n && "object" == typeof n) {
					k = n.length;
					for (f = 0; f < k; f += 1)"string" == typeof n[f] && (h = n[f], w = e(h, p), w && o.push(d(h) + (j ? ": " : ":") + w))
				} else
				for (h in p) Object.prototype.hasOwnProperty.call(p, h) && (w = e(h, p), w && o.push(d(h) + (j ? ": " : ":") + w));
				return w = 0 === o.length ? "{}" : j ? "{\n" + j + o.join(",\n" + j) + "\n" + P + "}" : "{" + o.join(",") + "}", j = P, w
			}
		}
		"use strict";
	...
	var m = "undefined" != typeof io ? io : module.parent.exports,
		...
		q = m.JSON,
		x = m.util.indexOf;p.encodePacket = function(a) {
		var b = x(u, a.type),
			c = a.id || "",
			d = a.endpoint || "",
			e = a.ack,
		...
		case "connect":
			...
			break;
		case "ack":
			f = a.ackId + (a.args && a.args.length ? "+" + q.stringify(a.args) : "")
		}
		b = [b, c + ("data" == e ? "+" : ""), d];
	...
	var A = /([^:]+):([0-9]+)?(\+)?:([^:]+)?:?([\s\S]*)?/;p.decodePacket = function(a) {
		var b = a.match(A);
		if (!b) return {};
		var c = b[2] || "",
			a = b[5] || "",
	...
	if ("undefined" != typeof window) {
		var Y, fa = function() {
			...
			na = function() {
				...
				if (0 < a) for (var b = 0; b < a; b++) {
					...
					if (0 < t.pv[0]) {
						var f = R(c);
						if (f) if (wa(aa[b].swfVersion) && !(t.wk && 312 > t.wk)) Z(c, !0), d && (e.success = !0, e.ref = oa(c), d(e));
			...
			Fa = function(a, b, c, d) {
				...
				if (e) {
					...
					d = t.ie && t.win ? ["Active"].concat("").join("X") : "PlugIn";
					...
					t.ie && (t.win && 4 != e.readyState) && (d = v.createElement("div"), c += "SWFObjectNew", d.setAttribute("id", c), e.parentNode.insertBefore(d, e), e.style.display = "none", function() {
			...
			va = function(a, b, c) {
				...
				if (e) if (typeof a.id == D && (a.id = c), t.ie && t.win) {
					var f = "",
						h;
			...
			Ga = function(a, b, c, d) {
				if (!t.ie || !t.mac) {
					...
					if (e) {
						...
						d && (ba = null, Ia = null);
						if (!ba || Ia != c) d = v.createElement("style"), d.setAttribute("type", "text/css"), d.setAttribute("media", c), ba = e.appendChild(d), t.ie && t.win && typeof v.styleSheets != D && 0 < v.styleSheets.length && (ba = v.styleSheets[v.styleSheets.length - 1]), Ia = c;
						t.ie && t.win ? ba && typeof ba.addRule == W && ba.addRule(a, b) : ba && typeof v.createTextNode != D && ba.appendChild(v.createTextNode(a + " {" + b + "}"))
					}
				}
			},
			Z = function(a, b) {
		...
		var Ha = !1,
			...
			Ca = !1,
			ba, Ia, Da = !0,
			t, o = typeof v.getElementById != D && typeof v.getElementsByTagName != D && typeof v.createElement != D,
		...
		t.w3 && ((typeof v.readyState != D && "complete" == v.readyState || typeof v.readyState == D && (v.getElementsByTagName("body")[0] || v.body)) && fa(), ja || (typeof v.addEventListener != D && v.addEventListener("DOMContentLoaded", fa, !1), t.ie && t.win && (v.attachEvent("onreadystatechange", function() {
		...
		Y = {
			...
			embedSWF: function(a, b, c, d, e, f, h, j, k, m) {
				...
				t.w3 && !(t.wk && t.wk < 312) && a && b && c && d && e ? (Z(b, false), Ea(function() {
					c = c + "";
					d = d + "";
					var n = {};
					if (k && typeof k === W) for (var p in k) n[p] = k[p];
					n.data = a;
					n.width = c;
					n.height = d;
					p = {};
					if (j && typeof j === W) for (var r in j) p[r] = j[r];
					if (h && typeof h === W) for (var q in h) typeof p.flashvars != D ? p.flashvars = p.flashvars + ("&" + q + "=" + h[q]) : p.flashvars = q + "=" + h[q];
					if (wa(e)) {
						r = va(n, p, b);
						n.id == b && Z(b, true);
						o.success = true;
			...
			expressInstallCallback: function() {
				if (Ca) {
					var a = R(Ba);
					a && qa && (a.parentNode.replaceChild(qa, a), ia && (Z(ia, true), t.ie && t.win && (qa.style.display = "block")), F && F(xa));
					Ca = false
				}
			}
		}
